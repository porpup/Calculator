...
public class Lab3_a_Lab5_Calculator extends JFrame {
	...
	public Lab3_a_Lab5_Calculator() {
		...
		aboutMenuItem.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				UIManager.put("Button.background", blueLight);
				UIManager.put("Button.foreground", Color.white);
				String message = "<html><body><div width='190px' align='center'>Author: Oleksandr Shyryayev<br>Herzing College student</div></body></html>";
				JOptionPane.showMessageDialog(frame, message, "", JOptionPane.PLAIN_MESSAGE);
			}
		});

		// Action to nightThemeMenuItem
		nightThemeMenuItem.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
		...
		dayThemeMenuItem.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
		...
		blueThemeMenuItem.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
